	...
	<body>
		...
		<div id="show-users" class="content scaffold-show" role="main">
			...
			<ol class="property-list users">
				...
				<g:if test="${usersInstance?.address}">
				<li class="fieldcontain">
					<span id="address-label" class="property-label"><g:message code="users.address.label" default="Address" /></span>
					
						<span class="property-value" aria-labelledby="address-label"><g:fieldValue bean="${usersInstance}" field="address"/></span>
